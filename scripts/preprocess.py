...
SOURCES = [
    ...
    },
    {
        ...
        'source_url': 'https://www.e-stat.go.jp/gis/statmap-search?type=2&aggregateUnitForBoundary=A&toukeiCode=00200521&toukeiYear=2020&serveyId=A002005212020',
        'retrieved': '2026-07',
        'processing': 'BigQuery GISで避難所点×小地域ポリゴンのST_CONTAINS空間結合→KEY_CODEで年齢結合し65歳以上/総数を算出。町丁目粒度でevacuation.geojsonに付与(scripts/aging_bq.sh→chome_aging.json)。未マッチ(島嶼等)は下記の市区町村値へfallback',
